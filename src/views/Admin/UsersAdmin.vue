  ...
  <div class="home">
    ...
    <div class="row">
      <div class="col-12 text-center users pb-5 pt-5">
        <img src="../../assets/users2.png" class="img-fluid mb-4 mt-5" />
        <h1 class="display-5">Utilizadores</h1>
      </div>
    </div>
              ...
              <div class="form-group">
                ...
                <select class="form-control mr-3" id="stlOrder">
                  <option value="A-Z" selected
                    >Utilizador - Ordem Alfabética Crescente</option
                  >
                  <option value="Z-A"
                    >Utilizador - Ordem Alfabética Decrescente</option
                  >
                </select>
              </div>
              <div class="form-group">
